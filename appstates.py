...
class Game:
    def __init__(self):
        ...
        self.game_state_manager = Game_state_manager('menu')
        self.play = Play(self.screen, self.game_state_manager)
        self.menu = Menu(self.screen, self.game_state_manager)
        self.cars = Cars(self.screen, self.game_state_manager)

        self.states = {'play':self.play, 'menu':self.menu, 'cars':self.cars}
            ...
            for event in pygame.event.get():
                if event.type == QUIT:
                    ...
                    if event.key == K_ESCAPE:
                        ...
                        self.game_state_manager.set_state('cars')
                    elif event.key == K_m:
...
class Play:
    ...
    def run(self): #For main game loop
